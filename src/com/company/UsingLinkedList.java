...
public class UsingLinkedList<T>
{
    ...
    /**
     * initializes linked list and sets head and current to null sets position to -1
     * to shoe an empty list
     */
    ...
    /**
     * @param data - data to be added] adds element to the list at end of the list
     */
    ...
    /**
     * @param data - data to be removed removes given element from the list
     */
    ...
    /**
     * @param data - data to be added adds data to the end of the list
     */
     ...
     * @returns position of the element in the list if it is in the list else
     *          returns -1
     */
